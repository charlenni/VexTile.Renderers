...
public static class DefaultTileDataSourceFactory
{
    ...
    public static ITileDataSource? CreateTileDataSource(string[] sources)
    {
        ...
        {
            FileScheme => CreateFileSource(source.Substring(FileScheme.Length + 3)),
    ...
    private static ITileDataSource CreateFileSource(string source)
    {
        return new MvtTileDataSource.MvtTileDataSource();
    }
